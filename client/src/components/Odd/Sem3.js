...
const Sem3 = () => {
    ...
    useEffect(() => {
        axios.get('http://localhost:5000/data3')
        ...
        <div className="container mt-4">
            ...
            <form onSubmit={changeOnClick} encType="multipart/form-data" >
                <div className="row mt-4 pt-5">
                    ...
                    <DropdownButton
                        ...
                        >
                            {subjects.map((sub, key) => (
                                <>
                                {sub.sem === 3 ? <Dropdown.Item eventKey={sub.sub}>{sub.sub}</Dropdown.Item> 
                                : <> </>}
                    ...
                    <div className="col-md-3 mb-3">
                        <input type="text" className="form-control" placeholder="Labs"
